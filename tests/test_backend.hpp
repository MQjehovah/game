...
public:
    ...
    neon::gfx::RenderTargetHandle CreateRenderTarget(int, int, bool, int) override { return {1}; }
    ...
    void ResolveRenderTarget(neon::gfx::RenderTargetHandle, neon::gfx::RenderTargetHandle) override {}
